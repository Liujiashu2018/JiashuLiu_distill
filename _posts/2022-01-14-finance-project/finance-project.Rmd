...
description: |
  What makes the CAPM different from the statistical model is that the CAPM imposes the constraint that the intercept or alpha is zero. This project includes a time series test of the CAPM and a cross-sectional test of the CAPM. My first finance project!
author:
  - name: Jiashu Liu
    url: {}
date: 10-12-2022
...
```{r}
knitr::include_graphics("CAPM.png")
```
